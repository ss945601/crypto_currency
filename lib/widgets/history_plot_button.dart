...
import 'package:crypto_currency/helper/loading_helper.dart';
...
class HistoryPlotButton extends StatelessWidget with LoadingHelper {
  final String coinID;
  ...
  Future<void> _showHistoryPlotDialog(BuildContext context) async {
    ...
    await withLoading(() async {
      historyData = HistoryData.fromJson(await Api()
                ...
                content: Column(
                  children: [
                    DropdownButton<HistoryInterval>(
                      ...
                      onChanged: (HistoryInterval? newValue) async {
                        if (newValue != null) {
